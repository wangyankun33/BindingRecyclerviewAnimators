...
namespace JP.Wasabeef.Recyclerview.Animators {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='ScaleInBottomAnimator']"
	[global::Android.Runtime.Register ("jp/wasabeef/recyclerview/animators/ScaleInBottomAnimator", DoNotGenerateAcw=true)]
	public partial class ScaleInBottomAnimator : global::JP.Wasabeef.Recyclerview.Animators.BaseItemAnimator {
		static readonly JniPeerMembers _members = new XAPeerMembers ("jp/wasabeef/recyclerview/animators/ScaleInBottomAnimator", typeof (ScaleInBottomAnimator));
		...
		protected ScaleInBottomAnimator (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='ScaleInBottomAnimator']/constructor[@name='ScaleInBottomAnimator' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ScaleInBottomAnimator () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='ScaleInBottomAnimator']/constructor[@name='ScaleInBottomAnimator' and count(parameter)=1 and parameter[1][@type='android.view.animation.Interpolator']]"
		[Register (".ctor", "(Landroid/view/animation/Interpolator;)V", "")]
		public unsafe ScaleInBottomAnimator (global::Android.Views.Animations.IInterpolator interpolator) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::JP.Wasabeef.Recyclerview.Animators.ScaleInBottomAnimator> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='ScaleInBottomAnimator']/method[@name='animateAddImpl' and count(parameter)=1 and parameter[1][@type='android.support.v7.widget.RecyclerView.ViewHolder']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='ScaleInBottomAnimator']/method[@name='animateRemoveImpl' and count(parameter)=1 and parameter[1][@type='android.support.v7.widget.RecyclerView.ViewHolder']]"
