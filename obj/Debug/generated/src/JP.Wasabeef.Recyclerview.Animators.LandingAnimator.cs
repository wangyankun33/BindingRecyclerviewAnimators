...
namespace JP.Wasabeef.Recyclerview.Animators {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='LandingAnimator']"
	[global::Android.Runtime.Register ("jp/wasabeef/recyclerview/animators/LandingAnimator", DoNotGenerateAcw=true)]
	public partial class LandingAnimator : global::JP.Wasabeef.Recyclerview.Animators.BaseItemAnimator {
		static readonly JniPeerMembers _members = new XAPeerMembers ("jp/wasabeef/recyclerview/animators/LandingAnimator", typeof (LandingAnimator));
		...
		protected LandingAnimator (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='LandingAnimator']/constructor[@name='LandingAnimator' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe LandingAnimator () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='LandingAnimator']/constructor[@name='LandingAnimator' and count(parameter)=1 and parameter[1][@type='android.view.animation.Interpolator']]"
		[Register (".ctor", "(Landroid/view/animation/Interpolator;)V", "")]
		public unsafe LandingAnimator (global::Android.Views.Animations.IInterpolator interpolator) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::JP.Wasabeef.Recyclerview.Animators.LandingAnimator> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='LandingAnimator']/method[@name='animateAddImpl' and count(parameter)=1 and parameter[1][@type='android.support.v7.widget.RecyclerView.ViewHolder']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='jp.wasabeef.recyclerview.animators']/class[@name='LandingAnimator']/method[@name='animateRemoveImpl' and count(parameter)=1 and parameter[1][@type='android.support.v7.widget.RecyclerView.ViewHolder']]"
